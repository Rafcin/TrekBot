...
PROJECT_PKG_CONFIG_INCLUDE_DIRS = "/xavier_ssd/TrekBot/TrekBot2_WS/install/include;/usr/include/eigen3;/usr/include".split(';') if "/xavier_ssd/TrekBot/TrekBot2_WS/install/include;/usr/include/eigen3;/usr/include" != "" else []
