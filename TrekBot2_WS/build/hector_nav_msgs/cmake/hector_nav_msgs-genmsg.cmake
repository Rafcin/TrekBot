...
get_filename_component(_filename "/xavier_ssd/TrekBot/TrekBot2_WS/src/hector_slam/hector_nav_msgs/srv/GetRobotTrajectory.srv" NAME_WE)
add_custom_target(_hector_nav_msgs_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "hector_nav_msgs" "/xavier_ssd/TrekBot/TrekBot2_WS/src/hector_slam/hector_nav_msgs/srv/GetRobotTrajectory.srv" "nav_msgs/Path:geometry_msgs/Pose:std_msgs/Header:geometry_msgs/Point:geometry_msgs/PoseStamped:geometry_msgs/Quaternion"
)

get_filename_component(_filename "/xavier_ssd/TrekBot/TrekBot2_WS/src/hector_slam/hector_nav_msgs/srv/GetSearchPosition.srv" NAME_WE)
add_custom_target(_hector_nav_msgs_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "hector_nav_msgs" "/xavier_ssd/TrekBot/TrekBot2_WS/src/hector_slam/hector_nav_msgs/srv/GetSearchPosition.srv" "geometry_msgs/Pose:geometry_msgs/Quaternion:geometry_msgs/Point:geometry_msgs/PoseStamped:std_msgs/Header"
)

get_filename_component(_filename "/xavier_ssd/TrekBot/TrekBot2_WS/src/hector_slam/hector_nav_msgs/srv/GetRecoveryInfo.srv" NAME_WE)
add_custom_target(_hector_nav_msgs_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "hector_nav_msgs" "/xavier_ssd/TrekBot/TrekBot2_WS/src/hector_slam/hector_nav_msgs/srv/GetRecoveryInfo.srv" "nav_msgs/Path:geometry_msgs/Pose:std_msgs/Header:geometry_msgs/Point:geometry_msgs/PoseStamped:geometry_msgs/Quaternion"
)

get_filename_component(_filename "/xavier_ssd/TrekBot/TrekBot2_WS/src/hector_slam/hector_nav_msgs/srv/GetDistanceToObstacle.srv" NAME_WE)
add_custom_target(_hector_nav_msgs_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "hector_nav_msgs" "/xavier_ssd/TrekBot/TrekBot2_WS/src/hector_slam/hector_nav_msgs/srv/GetDistanceToObstacle.srv" "std_msgs/Header:geometry_msgs/Point:geometry_msgs/PointStamped"
)

get_filename_component(_filename "/xavier_ssd/TrekBot/TrekBot2_WS/src/hector_slam/hector_nav_msgs/srv/GetNormal.srv" NAME_WE)
add_custom_target(_hector_nav_msgs_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "hector_nav_msgs" "/xavier_ssd/TrekBot/TrekBot2_WS/src/hector_slam/hector_nav_msgs/srv/GetNormal.srv" "geometry_msgs/Vector3:std_msgs/Header:geometry_msgs/Point:geometry_msgs/PointStamped"
)
