...
if("TRUE" STREQUAL "TRUE")
  set(image_geometry_SOURCE_PREFIX /xavier_ssd/TrekBot/TrekBot2_WS/src/vision_opencv/image_geometry)
  set(image_geometry_DEVEL_PREFIX /xavier_ssd/TrekBot/TrekBot2_WS/devel/.private/image_geometry)
  ...
  set(image_geometry_INSTALL_PREFIX /xavier_ssd/TrekBot/TrekBot2_WS/install)
...
if(NOT "/xavier_ssd/TrekBot/TrekBot2_WS/src/vision_opencv/image_geometry/include;/usr/local/include;/usr/local/include/opencv " STREQUAL " ")
  set(image_geometry_INCLUDE_DIRS "")
  set(_include_dirs "/xavier_ssd/TrekBot/TrekBot2_WS/src/vision_opencv/image_geometry/include;/usr/local/include;/usr/local/include/opencv")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'image_geometry' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/xavier_ssd/TrekBot/TrekBot2_WS/src/vision_opencv/image_geometry/${idir}'.  ${_report}")
    endif()
    _list_append_unique(image_geometry_INCLUDE_DIRS ${include})
  endforeach()
endif()

set(libraries "image_geometry;/usr/local/lib/libopencv_calib3d.so.3.4.1;/usr/local/lib/libopencv_core.so.3.4.1;/usr/local/lib/libopencv_cudaarithm.so.3.4.1;/usr/local/lib/libopencv_cudabgsegm.so.3.4.1;/usr/local/lib/libopencv_cudacodec.so.3.4.1;/usr/local/lib/libopencv_cudafeatures2d.so.3.4.1;/usr/local/lib/libopencv_cudafilters.so.3.4.1;/usr/local/lib/libopencv_cudaimgproc.so.3.4.1;/usr/local/lib/libopencv_cudalegacy.so.3.4.1;/usr/local/lib/libopencv_cudaobjdetect.so.3.4.1;/usr/local/lib/libopencv_cudaoptflow.so.3.4.1;/usr/local/lib/libopencv_cudastereo.so.3.4.1;/usr/local/lib/libopencv_cudawarping.so.3.4.1;/usr/local/lib/libopencv_cudev.so.3.4.1;/usr/local/lib/libopencv_dnn.so.3.4.1;/usr/local/lib/libopencv_features2d.so.3.4.1;/usr/local/lib/libopencv_flann.so.3.4.1;/usr/local/lib/libopencv_highgui.so.3.4.1;/usr/local/lib/libopencv_imgcodecs.so.3.4.1;/usr/local/lib/libopencv_imgproc.so.3.4.1;/usr/local/lib/libopencv_ml.so.3.4.1;/usr/local/lib/libopencv_objdetect.so.3.4.1;/usr/local/lib/libopencv_photo.so.3.4.1;/usr/local/lib/libopencv_shape.so.3.4.1;/usr/local/lib/libopencv_stitching.so.3.4.1;/usr/local/lib/libopencv_superres.so.3.4.1;/usr/local/lib/libopencv_video.so.3.4.1;/usr/local/lib/libopencv_videoio.so.3.4.1;/usr/local/lib/libopencv_videostab.so.3.4.1;/usr/local/lib/libopencv_viz.so.3.4.1")
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /xavier_ssd/TrekBot/TrekBot2_WS/devel/.private/image_geometry/lib;/xavier_ssd/TrekBot/TrekBot2_WS/devel/lib;/opt/ros/melodic/lib)
