...
if("TRUE" STREQUAL "TRUE")
  set(clear_costmap_recovery_SOURCE_PREFIX /xavier_ssd/TrekBot/TrekBot2_WS/src/navigation/clear_costmap_recovery)
  set(clear_costmap_recovery_DEVEL_PREFIX /xavier_ssd/TrekBot/TrekBot2_WS/devel/.private/clear_costmap_recovery)
  ...
  set(clear_costmap_recovery_INSTALL_PREFIX /xavier_ssd/TrekBot/TrekBot2_WS/install)
...
if(NOT "/xavier_ssd/TrekBot/TrekBot2_WS/src/navigation/clear_costmap_recovery/include " STREQUAL " ")
  set(clear_costmap_recovery_INCLUDE_DIRS "")
  set(_include_dirs "/xavier_ssd/TrekBot/TrekBot2_WS/src/navigation/clear_costmap_recovery/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'clear_costmap_recovery' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/xavier_ssd/TrekBot/TrekBot2_WS/src/navigation/clear_costmap_recovery/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /xavier_ssd/TrekBot/TrekBot2_WS/devel/.private/clear_costmap_recovery/lib;/xavier_ssd/TrekBot/TrekBot2_WS/devel/lib;/opt/ros/melodic/lib)
