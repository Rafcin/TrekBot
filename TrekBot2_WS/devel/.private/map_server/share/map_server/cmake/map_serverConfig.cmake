...
if("TRUE" STREQUAL "TRUE")
  set(map_server_SOURCE_PREFIX /xavier_ssd/TrekBot/TrekBot2_WS/src/navigation/map_server)
  set(map_server_DEVEL_PREFIX /xavier_ssd/TrekBot/TrekBot2_WS/devel/.private/map_server)
  ...
  set(map_server_INSTALL_PREFIX /xavier_ssd/TrekBot/TrekBot2_WS/install)
...
if(NOT "/xavier_ssd/TrekBot/TrekBot2_WS/src/navigation/map_server/include " STREQUAL " ")
  set(map_server_INCLUDE_DIRS "")
  set(_include_dirs "/xavier_ssd/TrekBot/TrekBot2_WS/src/navigation/map_server/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'map_server' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/xavier_ssd/TrekBot/TrekBot2_WS/src/navigation/map_server/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /xavier_ssd/TrekBot/TrekBot2_WS/devel/.private/map_server/lib;/xavier_ssd/TrekBot/TrekBot2_WS/devel/lib;/opt/ros/melodic/lib)
