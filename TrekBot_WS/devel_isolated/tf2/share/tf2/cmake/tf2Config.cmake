...
if("TRUE" STREQUAL "TRUE")
  set(tf2_SOURCE_PREFIX /xavier_ssd/TrekBot/TrekBot_WS/src/geometry2/tf2)
  set(tf2_DEVEL_PREFIX /xavier_ssd/TrekBot/TrekBot_WS/devel_isolated/tf2)
  set(tf2_INSTALL_PREFIX "")
  set(tf2_PREFIX ${tf2_DEVEL_PREFIX})
else()
  set(tf2_SOURCE_PREFIX "")
  set(tf2_DEVEL_PREFIX "")
  set(tf2_INSTALL_PREFIX /xavier_ssd/TrekBot/TrekBot_WS/install_isolated)
...
if(NOT "/xavier_ssd/TrekBot/TrekBot_WS/src/geometry2/tf2/include;/usr/include " STREQUAL " ")
  set(tf2_INCLUDE_DIRS "")
  set(_include_dirs "/xavier_ssd/TrekBot/TrekBot_WS/src/geometry2/tf2/include;/usr/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'tf2' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/xavier_ssd/TrekBot/TrekBot_WS/src/geometry2/tf2/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /xavier_ssd/TrekBot/TrekBot_WS/devel_isolated/tf2/lib;/xavier_ssd/TrekBot/TrekBot_WS/install_isolated/lib;/opt/ros/melodic/lib)
