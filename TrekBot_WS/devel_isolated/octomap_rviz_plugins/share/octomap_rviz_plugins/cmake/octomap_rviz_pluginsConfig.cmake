...
if("TRUE" STREQUAL "TRUE")
  set(octomap_rviz_plugins_SOURCE_PREFIX /xavier_ssd/TrekBot/TrekBot_WS/src/octomap_rviz_plugins)
  set(octomap_rviz_plugins_DEVEL_PREFIX /xavier_ssd/TrekBot/TrekBot_WS/devel_isolated/octomap_rviz_plugins)
  ...
  set(octomap_rviz_plugins_INSTALL_PREFIX /xavier_ssd/TrekBot/TrekBot_WS/install_isolated)
...
if(NOT "/xavier_ssd/TrekBot/TrekBot_WS/src/octomap_rviz_plugins/include " STREQUAL " ")
  set(octomap_rviz_plugins_INCLUDE_DIRS "")
  set(_include_dirs "/xavier_ssd/TrekBot/TrekBot_WS/src/octomap_rviz_plugins/include")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'octomap_rviz_plugins' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/xavier_ssd/TrekBot/TrekBot_WS/src/octomap_rviz_plugins/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /xavier_ssd/TrekBot/TrekBot_WS/devel_isolated/octomap_rviz_plugins/lib;/xavier_ssd/TrekBot/TrekBot_WS/install_isolated/lib;/opt/ros/melodic/lib)
