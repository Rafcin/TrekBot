...
set_target_properties(dynamicedt3d PROPERTIES
  IMPORTED_LINK_INTERFACE_LIBRARIES_RELEASE "/xavier_ssd/TrekBot/TrekBot_WS/install_isolated/lib/liboctomap.so;/xavier_ssd/TrekBot/TrekBot_WS/install_isolated/lib/liboctomath.so"
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libdynamicedt3d.so.1.9.0"
  IMPORTED_SONAME_RELEASE "libdynamicedt3d.so.1.9"
  )

list(APPEND _IMPORT_CHECK_TARGETS dynamicedt3d )
list(APPEND _IMPORT_CHECK_FILES_FOR_dynamicedt3d "${_IMPORT_PREFIX}/lib/libdynamicedt3d.so.1.9.0" )
